...
public class AnalMyFundListAdapter extends ArrayAdapter<PreviewMyProjClass> {

    List<PreviewMyProjClass> mData;
    Context context;

    public AnalMyFundListAdapter(@NonNull Context context, int resource, @NonNull List<PreviewMyProjClass> objects) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), AnalActivity.class);
